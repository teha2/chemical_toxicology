# -*- ChAIkerasExample.py -*-
"""
Created on Thurs Nov 14 17:08:54 2019 
...
hidden_layers = number of hidden layers, must be 1 or 2
LR = learning rate
...
if hidden_layers == 1:
    ...
    print("Number of hidden layers outside this model scope, please choose 1 or 2")
